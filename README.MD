...
```json
{
    ...
    "rules": [
        ...
        {
            "description": "Kicks every player whose username does not contain at least any three (3) consecutive latin letters",
            "type": "regex",
            "logic": "match=allow",
            "rule": "/[a-z]{3,}/"
        },
        {
            "description": "Kicks every player whose username does not contain at least any three (3) latin letters",
            "type": "regex",
            "logic": "match=allow",
            "rule": "/([a-z][^a-z]*?){3}/"
        },
